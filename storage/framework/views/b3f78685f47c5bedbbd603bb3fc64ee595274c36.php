<section>
    <h3 class="section-title after-line mt-35">Giới thiệu</h3>

    <div class="row mt-20">
        <div class="col-12 col-lg-6">
            <div class="form-group">
                <label class="input-label">Mô tả về bạn</label>
...
<?php /**PATH /var/www/rocket/resources/views/web/default/panel/setting/setting_includes/about.blade.php ENDPATH**/ ?>