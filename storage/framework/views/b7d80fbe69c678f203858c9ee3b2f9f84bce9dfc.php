...
unset($__errorArgs, $__bag); ?>" id="term">
                            <label class="custom-control-label font-14" for="term"><?php echo e(trans('auth.i_agree_with')); ?>
                                ...
                                <a href="pages/dieu-khoan-va-dieu-kien" target="_blank" class="text-secondary font-weight-bold font-14"><?php echo e(trans('auth.terms_and_rules')); ?></a>
                            </label>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/rocket/rocket/resources/views/web/default/auth/register.blade.php ENDPATH**/ ?>