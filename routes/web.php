...
Route::group(['namespace' => 'Web', 'middleware' => ['check_mobile_app', 'impersonate', 'share', 'check_maintenance', 'check_restriction']], function () {
    ...
    Route::group(['prefix' => 'payments'], function () {
        ...
        Route::post('/verify2/{channelId}', ['as' => 'payment_verify_post_2', 'uses' => 'PaymentController@paymentVerify2']);
        ...
        Route::get('/bank-transfer/{code}/{chanelId}', [PaymentController::class, 'bankTransfer'])->name('bankTransfer');
        Route::get('/get-order-by-code/{code}', [PaymentController::class, 'getOrderByCode']);
    });
